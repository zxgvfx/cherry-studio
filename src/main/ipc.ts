...
export async function registerIpc(mainWindow: BrowserWindow, app: Electron.App) {
  ...
  ipcMain.handle(IpcChannel.File_TranscodeAudioToWav, fileManager.transcodeAudioToWav.bind(fileManager))
  ipcMain.handle(IpcChannel.File_TranscodeAudio, fileManager.transcodeAudio.bind(fileManager))
